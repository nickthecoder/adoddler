...
configuration.register_action( "/pause", PauseAction() )
configuration.register_action( "/resume", ResumeAction() )
...
try :
    ...
    # Fail silently so that I can test on a machine without a camera using the same settings module.
    pass
